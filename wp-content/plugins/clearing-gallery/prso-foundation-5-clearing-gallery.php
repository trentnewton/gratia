<?php
/*
 * Plugin Name: Clearing Gallery
 * Plugin URI: 
 * Description: Enhance Wordpress gallery shortcode with the Clearing lightbox.
 * Author: Trent Newton
 * Version: 1.00
 * Author URI: http://www.trentnewton.com
 * License: GPL2+
 * Text Domain: clearing_gallery_plugin
...
define( 'PRSOFOUNDATION5GALLERY__DOMAIN', 'clearing_gallery_plugin' );
