...
class PrsoFoundation5Gallery {
	...
	*/
	public function foundation_gallery_shortcode($attr) {
		...
		switch( $columns ) {
			case 1:
				$block_class = apply_filters( 'prso_found_gallery_large_class', 'large-block-grid-1', $columns ) . ' ' . apply_filters( 'prso_found_gallery_small_class', 'small-block-grid-2', $columns );
				break;
			case 2:
				$block_class = apply_filters( 'prso_found_gallery_large_class', 'large-block-grid-2', $columns ) . ' ' . apply_filters( 'prso_found_gallery_small_class', 'small-block-grid-2', $columns );
				break;
			case 3:
				$block_class = apply_filters( 'prso_found_gallery_large_class', 'large-block-grid-3', $columns ) . ' ' . apply_filters( 'prso_found_gallery_small_class', 'small-block-grid-2', $columns );
				break;
			case 4:
				$block_class = apply_filters( 'prso_found_gallery_large_class', 'medium-block-grid-4', $columns ) . ' ' . apply_filters( 'prso_found_gallery_small_class', 'small-block-grid-2', $columns );
				break;
			case 5:
				$block_class = apply_filters( 'prso_found_gallery_large_class', 'large-block-grid-5', $columns ) . ' ' . apply_filters( 'prso_found_gallery_small_class', 'small-block-grid-2', $columns );
				break;
			case 6:
				$block_class = apply_filters( 'prso_found_gallery_large_class', 'large-block-grid-6', $columns ) . ' ' . apply_filters( 'prso_found_gallery_small_class', 'small-block-grid-2', $columns );
				break;
			default:
				$block_class = apply_filters( 'prso_found_gallery_large_class', 'large-block-grid-4', 'default' ) . ' ' . apply_filters( 'prso_found_gallery_small_class', 'small-block-grid-2', 'default' );
				break;
		}
		
		$gallery_container = "<div class='small-centered large-12 columns'><ul class='clearing-thumbs gallery galleryid-{$id} {$block_class} text-center' data-clearing>";
